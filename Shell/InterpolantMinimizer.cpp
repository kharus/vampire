...
namespace Shell
{
    ...
    std::unordered_map<Kernel::Unit*, Kernel::Color> InterpolantMinimizer::computeSplittingFunction(Kernel::Unit* refutation,  UnitWeight weightFunction)
    {
        ...
        */
        ...
        if (result == check_result::sat)
        {
            ...
            {
                cout << "expecting interpolant weight " << m.eval(penaltyFunction - c.real_val(1)) << std::endl;
            }
            else
            {
                cout << "expecting interpolant weight " << m.eval(penaltyFunction) << std::endl;
            }
    ...
    void InterpolantMinimizer::analyzeLocalProof(Kernel::Unit *refutation)
    {
        ...
        cout << "Number of red subproofs: " << representatives.size() << std::endl;
        ...
        cout << "Number of alternations: " << alternations.at(refutation) << std::endl;
    }
    ...
    void InterpolantMinimizer::analyzeGreyAreas(Kernel::Unit* refutation)
    {
        ...
        cout << "Proof contains " << number_red << " / " << number_blue << " / " << number_grey << " inferences (red/blue/grey)" << std::endl;
        cout << "Percentage of grey inferences: " << static_cast<double>(number_grey) / (number_red + number_blue + number_grey) << std::endl;
    }
