...
public:
  ...
  struct PreprocessingOptions
  {
     ...
     */
    void printOptionValues(std::ostream& out);
  private:
    friend class Problem;
    void validate() const;
   ...
   */
  void outputTypeDefinitions(std::ostream& out, bool outputAllTypeDefs=false);
   ...
   */
  void output(std::ostream& out, bool outputTypeDefs=false, bool outputAllTypeDefs=false);
