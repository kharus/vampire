...
struct EqualityResolution::ResultFn
{
  ...
  Clause* operator() (Literal* lit)
  {
    ...
    //cout << "arg0 " + arg0.toString() << std::endl;
    //cout << "arg1 " + arg1.toString() << std::endl;
    ...
    //cout << "equalityResolution with " + _cl->toString() << std::endl;
    //cout << "The literal is " + lit->toString() << std::endl;
    //cout << "cLength " << cLength << std::endl;
