...
struct EqualityFactoring::FactorablePairsFn
{
  ...
  VirtualIterator<std::pair<pair<Literal*,TermList>,std::pair<Literal*,TermList> > > operator() (std::pair<Literal*,TermList> arg)
  {
...
struct EqualityFactoring::ResultFn
{
  ...
  Clause* operator() (std::pair<pair<Literal*,TermList>,std::pair<Literal*,TermList> > arg)
  {
